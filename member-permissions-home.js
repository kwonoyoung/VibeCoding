(()=>{
  ...
  function addPublicStatsMenu(){
    if(document.querySelector('a.tool[href="public.html"]'))return;
    const main=document.querySelector('main.wrap');if(!main)return;
    const style=document.createElement('style');style.textContent=`.public-data-icon{background:linear-gradient(135deg,#e6faf7,#eaf1ff)!important;color:#087b74!important}.public-menu-badge{position:absolute;right:14px;bottom:12px;padding:5px 9px;border:1px solid #bce6dc;border-radius:999px;background:#e8f8f3;color:#087c65;font-size:10px;font-weight:900}.public-data-card{--accent:#087d75;--accent-soft:#e8f8f4}`;document.head.appendChild(style);
    const section=document.createElement('section');section.className='section';section.innerHTML='<div class="section-head"><div class="section-title"><div class="icon">▥</div><div><h2>공직 데이터</h2><p>공무원 보수·인력·채용·교육 통계 대시보드</p></div></div><div class="section-count">1개 페이지</div></div><div class="grid"><a class="tool people public-data-card" href="public.html"><div class="tool-top"><div class="tool-icon public-data-icon">↗</div><div class="arrow">→</div></div><h3>2008년 이후 공무원 관련 동향</h3><p>보수 인상률, 물가·최저임금, 공무원 인력, 5·7·9급 경쟁률, 교원 정원을 동적으로 비교합니다.</p><span class="public-menu-badge">공개</span></a></div>';
